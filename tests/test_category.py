...
def category_title():
    ...
    return Category('Настольные игры', 'Для веселого времяпровождения в компании', products, 1999.99,
                    18)
...
def test_category_total(category_title):
    assert category_title.total() == 1999.99 * 10 + 2999.99 * 5 + 3999.99 * 3 + 1999.99 * 18
...
def test_avg_calculater(category_title):
    category = Category('Настольные игры', 'Для веселого времяпровождения в компании',
                        [Product('Зомби в доме', 'Для веселого времяпровождения в компании', 1999.99, 10),
                         Product('Имаджинариум', 'Для веселого времяпровождения в компании', 2999.99, 5),
                         Product('Экивоки', 'Для веселого времяпровождения в компании', 3999.99, 3)],
                        1999.99, 18)
    assert category.avg_calculater() == 2999.99
